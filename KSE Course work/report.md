...
Далее по формуле (7) находится скорость испарения алюминиевого источника.
...
* найти межфазные потоки компонетов: AlCl<sub>3</sub>, GaCl
...
Решение обоих случаев приводится в файле **ru.shemplo.kse.course.task.TaskSolveAlGaN** 
